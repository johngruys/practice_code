...
icon_path = Dolphin.resource_path("Assets/dolphin.png")
icon = py.image.load(icon_path)
py.display.set_icon(icon)

### Background ###
background_path = Dolphin.resource_path("Assets/background.png")
background = py.image.load(background_path)
scroll = 0
...
### Background Music ###
say_hey_path = Dolphin.resource_path("Assets/say_hey.wav")
mixer.music.load(say_hey_path)
mixer.music.play(-1)
...
game_ended = False
played = False
empty_heart_path = Dolphin.resource_path("Assets/empty_heart.png")
full_heart_path = Dolphin.resource_path("Assets/full_heart.png")
empty_heart = py.image.load(empty_heart_path)
full_heart = py.image.load(full_heart_path)
