...
### Background music ###
game_ended = False
mixer.music.load("Games/sitest/SIAssets/background.wav")
mixer.music.play(-1)
...
icon = py.image.load("Games/sitest/SIAssets/vision_pixelated.png")
py.display.set_icon(icon)



### Creating Player ###
player_image = py.image.load("Games/sitest/SIAssets/spaceship.png")
playerX = 370
playerY = 480
playerX_change = 0
playerY_change = 0
...
def create_enemies(num_enemies):
    for i in range(num_enemies):
        enemy_image.append(py.image.load("Games/sitest/SIAssets/alien.png"))
...
### Bullet ###
laser_image = py.image.load("Games/sitest/SIAssets/laser.png")
laserX = 0
laserY = 480
laserY_change = -10
laser_state = "ready"
            ...
            if event.type == py.KEYDOWN:
                ...
                if event.key == py.K_SPACE:
                    if laser_state == "ready":
                        laser_sound = mixer.Sound("Games/sitest/SIAssets/laser.wav")
                        laser_sound.play()
                        laserX = playerX
                        laser_state = "fire"
